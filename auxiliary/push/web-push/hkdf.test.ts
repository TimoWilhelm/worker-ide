...
import { hkdfGenerate, hmacSign } from './hkdf';
...
describe('webpush helper hkdfGenerate and hmacSign', () => {
	...
	test('hkdfGenerate data', async () => {
		const ikm = new Uint8Array([
			98, 34, 225, 123, 163, 82, 246, 142, 66, 193, 206, 213, 202, 213, 45, 74, 154, 195, 179, 17, 56, 252, 18, 191, 215, 126, 82, 4, 85,
			41, 23, 74, 44, 147, 61, 30, 37, 39, 246, 185, 207, 0, 39, 203, 125, 171, 107, 91, 41, 118, 183, 247, 113, 88, 252, 94, 193, 19, 236,
			71, 86, 144, 219, 72,
		]);
		...
		const expectedValue = new Uint8Array([
			47, 101, 226, 47, 104, 106, 117, 246, 2, 90, 117, 101, 86, 202, 192, 46, 216, 254, 37, 79, 74, 60, 158, 29, 195, 1, 154, 227, 84, 226,
			221, 205,
		]);
