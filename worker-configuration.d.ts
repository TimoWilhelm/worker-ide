/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=auxiliary/biome/wrangler.jsonc --config=auxiliary/esbuild/wrangler.jsonc --config=auxiliary/vite-host/wrangler.jsonc --config=auxiliary/push/wrangler.jsonc --config=auxiliary/email/wrangler.jsonc` (hash: 64b048454e9c2872a4a0be656f963f0d)
