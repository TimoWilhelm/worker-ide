/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f2def97bdb2e093a3a66f6da0b085600)
// Runtime types generated with workerd@1.20260210.0 2026-01-31 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DurableObjectFilesystem" | "ProjectCoordinator";
	}
	interface Env {
		REPLICATE_RATE_LIMITER: RateLimit;
		LOADER: WorkerLoader;
		ASSETS: Fetcher;
		REPLICATE_API_TOKEN: string;
		DO_FILESYSTEM: DurableObjectNamespace<import("./worker/index").DurableObjectFilesystem>;
		DO_PROJECT_COORDINATOR: DurableObjectNamespace<import("./worker/index").ProjectCoordinator>;
	}
}
