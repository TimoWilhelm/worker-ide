/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c auxiliary/biome/wrangler.jsonc -c auxiliary/esbuild/wrangler.jsonc -c auxiliary/git/wrangler.jsonc -c auxiliary/push/wrangler.jsonc -c auxiliary/email/wrangler.jsonc` (hash: 9d48bad820887a1bcb75ac847bbedd9a)
// Runtime types generated with workerd@1.20260515.1 2026-03-24 no_handle_cross_request_promise_resolution,nodejs_compat
interface __BaseEnv_Env {
	...
	REPO_DO: DurableObjectNamespace<import("./auxiliary/git/index").RepoDurableObject>;
	...
	GIT_WORKER: Service<typeof import("./auxiliary/git/index").default>;
	DEPLOY_WORKFLOW: Workflow<Parameters<import("./worker/index").DeployWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DurableObjectFilesystem" | "AgentRunner" | "ProjectCoordinatorV2" | "ProjectMetadata";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PREVIEW_SECRET" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
