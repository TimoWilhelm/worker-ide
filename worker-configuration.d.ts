/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=auxiliary/biome/wrangler.jsonc --config=auxiliary/esbuild/wrangler.jsonc --config=auxiliary/vite-host/wrangler.jsonc --config=auxiliary/push/wrangler.jsonc --config=auxiliary/email/wrangler.jsonc` (hash: e72b6c77f3ac280f3b5f22759052e0a2)
