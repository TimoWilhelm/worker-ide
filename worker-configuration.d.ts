/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=auxiliary/biome/wrangler.jsonc --config=auxiliary/esbuild/wrangler.jsonc --config=auxiliary/push/wrangler.jsonc --config=auxiliary/email/wrangler.jsonc` (hash: a1303a3f7719347f45cf824426cbd7f7)
