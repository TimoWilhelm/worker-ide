/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=auxiliary/biome/wrangler.jsonc --config=auxiliary/esbuild/wrangler.jsonc --config=auxiliary/vite-host/wrangler.jsonc --config=auxiliary/vite-host-deploy/wrangler.jsonc --config=auxiliary/push/wrangler.jsonc --config=auxiliary/email/wrangler.jsonc` (hash: a14ca63d93e17362174d2208247f230c)
// Runtime types generated with workerd@1.20260617.1 2026-03-24 nodejs_compat
interface __BaseEnv_Env {
	STORAGE_BUCKET: R2Bucket;
	DB: D1Database;
	ANALYTICS_API: AnalyticsEngineDataset;
	ANALYTICS_PROJECTS: AnalyticsEngineDataset;
	ANALYTICS_AI: AnalyticsEngineDataset;
	ANALYTICS_PREVIEW: AnalyticsEngineDataset;
	ANALYTICS_AUTH: AnalyticsEngineDataset;
	ANALYTICS_WS: AnalyticsEngineDataset;
	ANALYTICS_STT: AnalyticsEngineDataset;
	ARTIFACTS: Artifacts;
	AI_RATE_LIMITER: RateLimit;
	PREVIEW_RATE_LIMITER: RateLimit;
	...
	BIOME: Service<typeof import("./auxiliary/biome/index").default>;
	ESBUILD: Service<typeof import("./auxiliary/esbuild/index").default>;
	VITE_HOST: Service<typeof import("./auxiliary/vite-host/index").default>;
	VITE_HOST_DEPLOY: Service<typeof import("./auxiliary/vite-host-deploy/index").default>;
	PUSH: Service<typeof import("./auxiliary/push/index").default>;
	EMAIL: Service<typeof import("./auxiliary/email/index").default>;
	DEPLOY_WORKFLOW: Workflow<Parameters<import("./worker/index").DeployWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DurableObjectFilesystem" | "AgentRunner" | "ProjectCoordinatorV2" | "ProjectMetadata" | "VinextPreviewHost";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PREVIEW_SECRET" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "CLOUDFLARE_OAUTH_CLIENT_ID" | "CLOUDFLARE_OAUTH_CLIENT_SECRET">> {}
}
