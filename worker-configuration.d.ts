/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=auxiliary/biome/wrangler.jsonc --config=auxiliary/esbuild/wrangler.jsonc --config=auxiliary/vite-host/wrangler.jsonc --config=auxiliary/push/wrangler.jsonc --config=auxiliary/email/wrangler.jsonc` (hash: ecb72eae2a53f15c0e3cc6040d8daa63)
// Runtime types generated with workerd@1.20260708.1 2026-03-24 enable_ctx_exports,nodejs_compat
